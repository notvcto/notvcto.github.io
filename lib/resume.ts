...
export const resume: ResumeData = {
    ...
    education: [
        ...
        {
            credential: {
                en: "National Recognition — Highest Grade, Computer Science Workshop",
                es: "Reconocimiento Nacional — Más Alta Calificación, Taller de Informática",
            },
