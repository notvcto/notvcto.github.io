// This version of the Buy Me a Coffee widget script is edited for dark mode styling.
!(function (t) {
  var e = {};
  function s(i) {
  ...
  function (t, e) {
    ...
    window.addEventListener("DOMContentLoaded", function () {
      ...
      (l.style.position = "fixed"),
        ...
        (l.style.width = "0"),
        (l.style.height = "0"),
        (l.style.background = "rgba(0, 0, 0, 0.8)"),
      ...
      a.setAttribute("id", "bmc-iframe"),
        ...
        t.matches
          ? ("left" == s.dataset.position
            ...
            (a.style.bottom = parseInt(s.dataset.y_margin, 10) + 72 + "px"))
          : ((a.style.left = "0px"),
            (a.style.right = "0px"),
            (a.style.top = "0px"),
            (a.style.bottom = "32px")),
      ...
      (o.style.position = "fixed"),
        ...
        (o.style.background = "#2e2e2e"),
        (o.style.zIndex = "9999"),
        (o.innerText = s.dataset.message),
        (o.style.boxShadow =
          "0px 2px 5px rgba(0, 0, 0, 0.2), 0px 8px 40px rgba(0, 0, 0, 0.2), 0px 0px 2px rgba(0, 0, 0, 0.4)"),
        (o.style.padding = "16px 16px"),
        (o.style.borderRadius = "4px"),
        (o.style.fontSize = "18px"),
        (o.style.color = "#f5f5f5"),
        (o.style.width = "auto"),
