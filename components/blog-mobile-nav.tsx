...
import { BookOpen, ChevronRight, List, Search, X } from "lucide-react";
                                                                ...
                                                                <li key={post.slug}>
                                                                    ...
                                                                    >
                                                                        <div className="flex items-center gap-3">
                                                                            <BookOpen
                                                                                className={`w-4 h-4 ${isActive ? "text-accent" : "opacity-30"}`}
                                                                            />
                                                                        ...
                                                                        <ChevronRight
                                                                            className={`w-4 h-4 transition-transform ${isActive ? "opacity-100" : "opacity-20"}`}
                                                                        />
                                                                    </Link>
                                                                </li>
                                                            );
