...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["notvcto-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
            ...
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    ...
                    <div id="cmd" onClick={this.focusCursor} className=" bg-transperent relative flex-1 overflow-hidden">
                        ...
                        <input id={`terminal-input-${id}`} data-row-id={id} onKeyDown={this.checkKey} onBlur={this.unFocusCursor} className=" absolute top-0 left-0 w-full opacity-0 outline-none bg-transparent" spellCheck={false} autoFocus={typeof window !== 'undefined'} autoComplete="off" type="text" />
                    </div>
                </div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-vcto, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
